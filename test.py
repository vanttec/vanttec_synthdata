...
"""This is a test script that outputs that rendered image."""
...
# Trigger words: UNDERWATER_SCENE and aqua
pipe.load_lora_weights('Ivan5d/lora_deep_sea', weight_name='UNDERWATER_SCENE_v2.safetensors', adapter_name="underwater_scene")
